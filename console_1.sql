...
--#9
select * from cars where model like 'T%';  --select * from cars where brand like 'T%';
--#10
select * from cars where model like '%e';
--#11
select * from cars where length(brand) = 5;
--#12
select round( sum(price)) from cars where brand = 'Mercedes-Benz';
--#13
select * from cars where price = (select min(price)from cars) limit 1;
select * from cars where price = (select max(price)from cars) limit 1;
--#14
